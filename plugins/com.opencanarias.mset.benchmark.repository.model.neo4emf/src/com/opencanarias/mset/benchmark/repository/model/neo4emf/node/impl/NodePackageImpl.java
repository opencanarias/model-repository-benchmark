...
public class NodePackageImpl extends EPackageImpl implements NodePackage {
	 ...
	 * @see com.opencanarias.mset.benchmark.repository.model.neo4emf.node.NodePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EAttribute getNode_String() {
	 ...
	 * @generated
	 */
	public EAttribute getNode_Integer() {
	 ...
	 * @generated
	 */
	public EAttribute getNode_ByteArray() {
	...
	public void createPackageContents() {
		...
		createEAttribute(nodeEClass, NODE__STRING);
		createEAttribute(nodeEClass, NODE__INTEGER);
		createEAttribute(nodeEClass, NODE__BYTE_ARRAY);
	}
	...
	public void initializePackageContents() {
		...
		initEAttribute(getNode_String(), ecorePackage.getEString(), "string", null, 0, 1, Node.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getNode_Integer(), ecorePackage.getEInt(), "integer", null, 0, 1, Node.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getNode_ByteArray(), ecorePackage.getEByteArray(), "byteArray", null, 0, 1, Node.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
