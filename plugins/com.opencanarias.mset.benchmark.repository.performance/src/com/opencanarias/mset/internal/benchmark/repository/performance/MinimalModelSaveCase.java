...
public class MinimalModelSaveCase extends ModelSaveCase implements IBenchmarkCase {
	
	public MinimalModelSaveCase(IBenchmarkGroup group) {
		super(group, SampleModelPool.get1ModelURI());
	}
